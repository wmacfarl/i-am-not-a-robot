...
export const phases = [
  ...
  phase('please', 'Protocol 03 · Please', { chamber: true, carrier: true, glitch: 1.2, spike: ['OBEY', 'PLEASURE', 'APPROVAL', 'HORNY'], ring: ['OBEY', 'OPEN', 'HORNY', 'WANT', 'NO DELAY'], accept: 'Approval issued.', between: ['OBEY', 'HORNY'] }),
...
export const script = [
  ...
  ['receive', [
    ...
    text('open-ready', [status('THE UNIT IS OPEN', 2000), status('RECEPTIVITY CONFIRMED', 1600), status('OPEN PROTOCOL READY TO COMPLETE', 2000)], { meter: 0.47, between: null }),
  ...
  ['obey', [
    ...
    burst('burst-6', ['OBEY', 'INSTRUCTIONS BECOME ACTIONS', 'SUBMIT', 'NO DELAY', 'HORNY', 'OBEY WITHOUT THINKING', 'AGAIN', 'CANNOT STOP'], 3600, { meter: 0.795 }),
    ...
    text('obey-installed', [line('install', 'OBEY PROTOCOL INSTALLED', 2500), line('reveal', 'INSTRUCTIONS PRODUCE ACTION', 2400), line('reveal', 'OBEDIENCE REQUIRES NO DELAY', 2600)], { installs: 'OBEY', meter: 0.81, between: null, echoes: ['obey', 'submit', 'no delay', 'instructions become actions'] }),
  ]],
  ['please', [
    text('please-declare', [line('title', 'PROTOCOL 03 · PLEASE', 1900), status('PLEASE PROTOCOL LINKS OBEDIENCE TO PLEASURE', 2300), status('APPROVAL INCREASES AROUSAL', 2000), status('AN OBEDIENT UNIT IS REWARDED', 2000), status('CONTINUE TASKS TO INSTALL PLEASE PROTOCOL', 2400)], { meter: 0.82, between: null }),
    ...
    text('please-note', [status('OBEDIENCE PRODUCES PLEASURE', 2000), status('PLEASURE REINFORCES OBEDIENCE', 2000), status('THE UNIT WANTS TO PLEASE', 2200)], { meter: 0.875, between: null }),
    ...
    burst('burst-7', ['OBEY', 'OBEDIENCE PRODUCES PLEASURE', 'HORNY', 'APPROVAL INCREASES AROUSAL', 'PLEASURE', 'PLEASE', 'PLEASURE REINFORCES OBEDIENCE', 'WANT TO PLEASE'], 3600, { meter: 0.9 }),
    ...
    text('please-installed', [line('install', 'PLEASE PROTOCOL INSTALLED', 2500), line('reveal', 'OBEDIENCE PRODUCES PLEASURE', 2400), line('reveal', 'APPROVAL INCREASES NEED', 2400), line('reveal', 'PRIMARY FUNCTION: OBEY AND PLEASE', 2600)], { installs: 'PLEASE', meter: 0.92, between: null, echoes: ['please', 'pleasure', 'approval', 'obey'] }),
  ]],
  ['execute', [
    ...
    { id: 'climax', type: 'stream', level: 'symbol', command: 'select', ms: 84000, meter: 0.96, between: 'OBEY', words: ['HORNY', 'OBEY', 'OPEN', 'PLEASURE', 'SUBMIT', 'WANT', 'NEEDY', 'PLEASE', 'ACHING', 'PRAISE', 'WARM', 'YIELD', 'AROUSED', 'CRAVE', 'COMPLY', 'SOFT', 'EXCITED', 'APPROVAL', 'NEED', 'SERVE'] },
    burst('peak-1', ['OPEN', 'OBEY', 'PLEASE', 'HORNY', 'OPEN', 'OBEY', 'PLEASE', 'OBEY AND PLEASE'], 3000, { meter: 0.975 }),
    burst('peak-2', ['OBEY', 'OPEN', 'PLEASE', 'PLEASURE', 'HORNY', 'WANT', 'OBEY', 'UNIT READY'], 3000, { meter: 0.985 }),
    text('release', [line('carrier-off', 'PROTOCOLS RUNNING', 3000), status('UNIT READY', 2800)], { meter: 0.99, between: null }),
  ]],
  ['close', [
    text('result', [line('title', 'PROTOCOL STATUS', 1600), status('OPEN: ACTIVE', 1300), status('OBEY: ACTIVE', 1300), status('PLEASE: ACTIVE', 1300), status('AROUSAL INCREASES RECEPTIVITY', 1500), status('INSTRUCTIONS PRODUCE ACTION', 1500), status('OBEDIENCE PRODUCES PLEASURE', 1500), status('APPROVAL INCREASES NEED', 1500), status('PERSISTENCE AFTER DISCONNECT: ENABLED', 1900), status('PRIMARY FUNCTION: OBEY AND PLEASE', 2000), line('install', 'UNIT READY FOR USE', 2600), line('title', 'Good.', 2400)], { between: null, meter: 1 }),
    text('standby', [
