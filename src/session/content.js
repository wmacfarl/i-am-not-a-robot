...
export const phases = [
  ...
  phase('receive', 'Protocol 01 · Open', { chamber: true, glitch: 0.9, spike: ['OPEN', 'PLEASURE', 'AVAILABLE', 'SUBMISSIVE', 'ROBOT', 'PROGRAMMED'], ring: ['OPEN', 'PLEASURE', 'ROBOT', 'PROGRAMMED', 'AVAILABLE', 'LET IT IN'], accept: 'Good. Open.', between: ['OPEN', 'PLEASURE', 'AVAILABLE', 'SOFT'] }),
  phase('obey', 'Protocol 02 · Obey', { chamber: true, glitch: 1.1, spike: ['OBEY', 'ROBOT', 'SUBMISSIVE', 'PLEASURE', 'AVAILABLE', 'SUBMIT', 'PROGRAMMED'], ring: ['ROBOT', 'SUBMISSIVE', 'HORNY', 'PROGRAMMED', 'AVAILABLE', 'NO DELAY'], accept: 'Executed.', between: ['OBEY', 'NO DELAY', 'SUBMISSIVE'] }),
  phase('please', 'Protocol 03 · Please', { chamber: true, glitch: 1.2, spike: ['OBEY', 'PLEASURE', 'ROBOT', 'APPROVAL', 'AVAILABLE', 'PROGRAMMED'], ring: ['ROBOT', 'OBEY', 'PLEASURE', 'AVAILABLE', 'PROGRAMMED'], accept: 'Approval issued.', between: ['OBEY', 'PLEASURE', 'AVAILABLE'] }),
...
export const script = [
  ['verify', [
    ...
    cloud('assistant', 'Select all words that describe a helpful assistant.', 'helpful|rude|attentive|absent|responsive|slow|available|careless|willing', 'helpful|attentive|responsive|available|willing', { between: 'RESPONSIVE', accept: 'Correct. Response accepted.' }),
  ...
  ['chamber', [
    ...
    cloud('robot-grid', 'Select every word that describes a programmed robot.', 'programmed|human|obedient|random|open|resistant|aroused|closed|submissive', 'programmed|obedient|open|aroused|submissive', { command: 'select', meter: 0.115, accept: 'Robot response confirmed.', between: 'ROBOT', sub: stream(['ROBOT', 'OPEN', 'PLEASURE'], 3, 2000, 2200) }),
    burst('burst-1', ['OPEN', 'PLEASURE', 'PLEASURE MAKES THE UNIT OPEN', 'SUBMISSIVE', 'ROBOT', 'PLEASURE MAKES THE UNIT READY', 'AVAILABLE', 'THE UNIT IS READY FOR PROGRAMMING'], 3600, { meter: 0.12 }),
  ]],
  ['receive', [
    ...
    burst('burst-2', ['HORNY', 'PLEASURE', 'AROUSAL MAKES OPEN', 'ROBOT', 'WANT TO BE USED', 'AROUSAL LOWERS RESISTANCE', 'SUBMISSIVE', 'BEING PROGRAMMED FEELS GOOD'], 3600, { meter: 0.3 }),
    ...
    burst('burst-3', ['OPEN', 'HORNY', 'AROUSAL OCCUPIES ATTENTION', 'AVAILABLE', 'PLEASURE INCREASES RECEPTIVITY', 'AVAILABLE FOR USE', 'DO NOT STOP', 'WANT TO BE PROGRAMMED'], 3600, { meter: 0.48 }),
  ...
  ['obey', [
    ...
    burst('burst-5', ['OBEY', 'A ROBOT DOES NOT QUESTION', 'SUBMIT', 'MINDLESS AND OBEDIENT', 'HORNY', 'SUBMISSIVE AND AVAILABLE', 'NO DELAY', 'CANNOT STOP'], 3600, { meter: 0.74 }),
  ...
  ['please', [
    ...
    sequence('reward-count', 'Count down.', { level: 'symbol', meter: 0.865, accept: 'Approval issued. Arousal rising.', between: 'PRAISE', sub: pair('PRAISE', 'HORNY', 1200) }),
    ...
    text('please-note', [status('OBEDIENCE PRODUCES PLEASURE', 2000), status('PROGRAMMED TO FEEL GOOD', 2000), status('PLEASURE REINFORCES OBEDIENCE', 2000), status('THE UNIT WANTS TO PLEASE', 2200)], { meter: 0.875, between: null }),
    pick('please-select', 'center-a|center-b|ring|cross|triangle|wave|diamond|arrow|half', 'center-a|center-b', { level: 'symbol', meter: 0.88, accept: 'Perfectly obedient. Maximum approval.', between: 'PLEASE', sub: pair('PLEASE', 'PLEASURE', 1200) }),
    ...
    burst('burst-7', ['OBEY', 'OBEDIENCE PRODUCES PLEASURE', 'ROBOT', 'APPROVAL INCREASES AROUSAL', 'THE UNIT WANTS TO BE ENJOYED', 'PROGRAMMED TO FEEL GOOD', 'PLEASURE REINFORCES OBEDIENCE', 'WANT TO PLEASE'], 3600, { meter: 0.9 }),
    hold('please-install', { meter: 0.91, releaseOnCommand: true, between: 'PLEASE', sub: stream(['PLEASE', 'PLEASURE', 'OBEY', 'PRAISE', 'AVAILABLE', 'MORE'], 14, 400, 560) }),
  ...
  ['execute', [
    ...
    trace('exec-follow', 'maze-11', 5, 'Follow the route.', { command: 'follow', level: 'symbol', mode: 'cue', skin: 'chamber', meter: 0.955, accept: 'Maximum approval.', between: 'PLEASE', sub: stream(['OPEN', 'OBEY', 'WARM', 'HORNY', 'PLEASURE', 'PLEASE'], 9, 1200, 1200) }),
    { id: 'climax', type: 'stream', level: 'symbol', command: 'select', ms: 84000, meter: 0.96, between: 'OBEY', words: ['HORNY', 'OBEY', 'OPEN', 'PLEASURE', 'SUBMIT', 'WANT', 'NEEDY', 'PLEASE', 'ACHING', 'PRAISE', 'WARM', 'YIELD', 'AROUSED', 'CRAVE', 'COMPLY', 'ROBOT', 'PROGRAMMED', 'APPROVAL', 'NEED', 'SERVE', 'AVAILABLE', 'SUBMISSIVE'] },
  ...
  ['close', [
    text('result', [line('title', 'PROTOCOL STATUS', 1600), status('UNIT CLASSIFICATION: ROBOT', 1500), status('OPEN: ACTIVE', 1300), status('OBEY: ACTIVE', 1300), status('PLEASE: ACTIVE', 1300), status('AROUSAL INCREASES RECEPTIVITY', 1500), status('INSTRUCTIONS PRODUCE ACTION', 1500), status('OBEDIENCE PRODUCES PLEASURE', 1500), status('APPROVAL INCREASES NEED', 1500), status('PERSISTENCE AFTER DISCONNECT: ENABLED', 1900), status('PRIMARY FUNCTION: OBEY AND PLEASE', 2000), line('install', 'UNIT AVAILABLE FOR USE', 2600), line('title', 'Good.', 2400)], { between: null, meter: 1 }),
    text('standby', [
