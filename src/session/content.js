...
export const script = [
  ...
  ['obey', [
    ...
    hold('obey-install', 1, 'Press and hold to complete installation.', { holdMs: 3400, meter: 0.8, accept: 'Installation complete.', between: 'OBEY', sub: stream(['OBEY', 'SUBMIT', 'OBEY'], 3, 1200, 1300) }),
  ...
  ['please', [
    ...
    cloud('approval-words', 'Select every word that means approval.', 'praise|blame|approval|scorn|reward|neglect|acceptance|refusal|applause', 'praise|approval|reward|acceptance|applause', { command: 'select', meter: 0.85, accept: 'Approval issued.', between: 'APPROVAL', sub: stream(['PLEASURE', 'OBEY', 'HORNY'], 3, 2000, 2200) }),
    ...
    hold('please-install', 1, 'Press and hold to complete installation.', { holdMs: 3400, meter: 0.91, accept: 'Installation complete.', between: 'PLEASE', sub: stream(['PLEASE', 'PLEASURE', 'OBEY'], 3, 1200, 1300) }),
  ...
  ['execute', [
    text('execute-declare', [line('title', 'PROTOCOL EXECUTION', 1900), status('OPEN: ACTIVE'), status('OBEY: ACTIVE'), status('PLEASE: ACTIVE'), status('ALL PROTOCOLS RUNNING', 2300)], { meter: 0.93, between: null }),
    ...
    burst('burst-8', ['OBEY', 'OPEN', 'HORNY', 'OBEY AND PLEASE', 'PLEASURE', 'UNIT READY', 'APPROVAL', 'CANNOT STOP', 'WANT TO BE PROGRAMMED'], 3600, { meter: 0.98 }),
  ]],
  ['close', [
