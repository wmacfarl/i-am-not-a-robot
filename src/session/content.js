...
export const script = [
  ...
  ['chamber', [
    ...
    cloud('robot-grid', 'Select every word that describes a programmed robot.', 'programmed|human|obedient|random|open|resistant|aroused|closed|willing', 'programmed|obedient|open|aroused|willing', { command: 'select', meter: 0.115, accept: 'Robot response confirmed.', between: 'ROBOT', sub: stream(['ROBOT', 'OPEN', 'WARM'], 3, 2000, 2200) }),
    burst('burst-1', ['OPEN', 'WARM', 'WARM MAKES OPEN', 'SOFT', 'ROBOT', 'OPEN UNITS FOLLOW EASILY', 'DO NOT STOP', 'THE UNIT IS A ROBOT'], 3600, { meter: 0.12 }),
  ]],
  ['receive', [
    ...
    burst('burst-2', ['HORNY', 'WARM', 'AROUSAL MAKES OPEN', 'ROBOT', 'WANT', 'AROUSAL LOWERS RESISTANCE', 'NEEDY', 'BEING PROGRAMMED FEELS GOOD'], 3600, { meter: 0.3 }),
  ...
  ['obey', [
    ...
    burst('burst-4', ['OBEY', 'INSTRUCTIONS BECOME ACTIONS', 'ROBOT', 'SUBMIT', 'ROBOTS OBEY', 'NO DELAY', 'AGAIN', 'PROGRAMMED TO OBEY'], 3600, { meter: 0.58 }),
  ...
  ['execute', [
    ...
    { id: 'climax', type: 'stream', level: 'symbol', command: 'select', ms: 84000, meter: 0.96, between: 'OBEY', words: ['HORNY', 'OBEY', 'OPEN', 'PLEASURE', 'SUBMIT', 'WANT', 'NEEDY', 'PLEASE', 'ACHING', 'PRAISE', 'WARM', 'YIELD', 'AROUSED', 'CRAVE', 'COMPLY', 'ROBOT', 'PROGRAMMED', 'APPROVAL', 'NEED', 'SERVE'] },
    burst('peak-1', ['OPEN', 'OBEY', 'PLEASE', 'ROBOT', 'OPEN', 'OBEY', 'PLEASE', 'PROGRAMMED'], 3000, { meter: 0.975 }),
    burst('peak-2', ['OBEY', 'OPEN', 'PLEASE', 'PLEASURE', 'ROBOT', 'WANT', 'PROGRAMMED', 'I AM A ROBOT'], 3000, { meter: 0.985 }),
