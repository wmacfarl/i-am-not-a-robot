...
the human check, and opens a programming chamber that installs three protocols:
`OPEN`, `OBEY` and `PLEASE`.
...
[docs/covert-priming-design.md](./docs/covert-priming-design.md): ten sections
and 107 steps, about 22 minutes at a brisk pace and 30 for a deliberate
...
- `src/session/content.js`: symbol vocabulary, phases, and the authored script.
  ...
  interlude text or a burst; it carries its instruction level (`full`, `word`,
